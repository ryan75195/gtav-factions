...
namespace FactionWars.Economy.Services
{
    ...
    public class ResourceTickService : IResourceTickService
    {
        ...
        private (int cash, int recruitment, int weapons) CalculateFactionResources(string factionId)
        {
            ...
            {
                var zoneResources = CalculateZoneResources(zone);
        ...
        /// <summary>
        /// Calculates resources generated by a single zone.
        /// </summary>
        /// <param name="zone">The zone to calculate resources for.</param>
        /// <returns>Tuple containing cash, recruitment, and weapons generated.</returns>
        private (int cash, int recruitment, int weapons) CalculateZoneResources(Territory.Models.Zone zone)
        {
            ...
            int finalCash = (int)(baseCash * cashModifier);
            int finalRecruitment = (int)(baseRecruitment * recruitmentModifier);
            int finalWeapons = (int)(baseWeapons * weaponsModifier);
