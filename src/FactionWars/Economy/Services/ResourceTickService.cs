...
namespace FactionWars.Economy.Services
{
    ...
    public class ResourceTickService : IResourceTickService
    {
        ...
        /// <returns>The cash, recruitment, and weapons generated.</returns>
        private ResourceAmounts CalculateFactionResources(string factionId)
        {
            ...
            return new ResourceAmounts(totalCash, totalRecruitment, totalWeapons);
        }
        ...
        /// <returns>The cash, recruitment, and weapons generated.</returns>
        private ResourceAmounts CalculateZoneResources(string factionId, Territory.Models.Zone zone)
        {
            ...
            return new ResourceAmounts(finalCash, finalRecruitment, finalWeapons);
        }

        private readonly struct ResourceAmounts
        {
            public ResourceAmounts(int cash, int recruitment, int weapons)
            {
                Cash = cash;
